...
import { IUserResponse, UserData } from "@/app/core/application/dto/users/user-response.dto";
...
export class UsersServices implements PUsers {
    ...
    async createUser(user: IUserRegister): Promise<IRegisterResponse> {
        return await this.clientHttp.post(this.basePath, user);
    }
